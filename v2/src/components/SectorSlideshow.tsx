...
export default function SectorSlideshow() {
  ...
  return (
    <div className="relative w-full bg-transparent flex flex-col items-center overflow-x-hidden pt-20">
      ...
      <div
        className="relative w-full min-h-[50vh] md:min-h-[75vh] flex items-center justify-center py-8 md:py-16 mb-24"
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow:
                    position === "center"
                      ? "0 30px 60px -15px rgba(6, 182, 212, 0.4), 0 0 40px rgba(6, 182, 212, 0.2)"
