      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-20">
          ...
          >
            ...
            <div className="h-24 sm:h-28 md:h-36 w-[320px] md:w-[450px] px-4 md:px-0 bg-gradient-to-br from-white/[0.08] to-transparent backdrop-blur-2xl rounded-[2.5rem] border border-white/10 flex items-center justify-center shadow-2xl overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
              <span className="text-white/20 font-bold tracking-[0.3em] text-xl uppercase">PEARLIXAI LOGO</span>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-32 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="relative aspect-square rounded-[3rem] overflow-hidden border border-white/10 shadow-[0_0_80px_rgba(16,185,129,0.1)] group bg-white/[0.02] flex items-center justify-center">
               <div className="text-white/10 text-center px-10 border-2 border-dashed border-white/5 rounded-[2rem] py-24 uppercase tracking-[0.2em] text-sm">
                 Microstructure Analysis Interior
               </div>
