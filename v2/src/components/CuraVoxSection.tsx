...
const features = [
  {
    ...
    description:
      "Auto-detects and reads medicine packages instantly. Smart filtering automatically rejects non-medicine items like receipts, minimizing errors and saving time.",
  },
  {
    icon: Mic,
    title: "Voice-Activated Expert",
    description:
      "Press a single button to ask questions in natural language. Receives clear, spoken, human-like responses translating complex pharmacological data.",
  },
  {
    icon: ShieldAlert,
    title: "Clinical Safety Checker",
    description:
      "Compares multiple medications to proactively warn about severe, moderate, or minor interactions, translating medical jargon into practical advice.",
  },
  {
    icon: HeartPulse,
    title: "Health Vault & Reminders",
    description:
      "Securely logs every scanned medicine. Set voice reminders like 'Remind me to take my pill at 8 AM' and sync seamlessly across devices for caregivers.",
  },
];
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-32 items-center mb-32">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="relative w-full aspect-video md:aspect-[4/3] lg:aspect-video rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_100px_rgba(6,182,212,0.15)] group bg-[#020617]/80">
              <div className="absolute inset-0 flex items-center justify-center p-1">
                <img
                  src="/images/curavox/home.png"
                  alt="CuraVox Dashboard visual"
                  className="w-full h-full object-cover opacity-95 group-hover:scale-105 transition-transform duration-1000 rounded-[1.35rem]"
                />
              </div>
              <div className="absolute inset-0 bg-gradient-to-t from-[#020617]/80 via-transparent to-transparent opacity-80 pointer-events-none" />
              ...
              <div className="relative z-10 space-y-12">
                <div className="space-y-6">
                  <h3 className="text-3xl md:text-5xl font-bold text-white tracking-tight leading-tight">
                    Revolutionary Voice-First Health Assistant
                  </h3>
                  <p className="text-slate-200 leading-relaxed text-lg lg:text-xl font-light">
                    CuraVox is an intelligent personal health assistant designed
                    to make medication management safe, accessible, and
                    effortless. Built practically for individuals with visual
        ...
        >
          <div className="text-center mb-16 relative z-10">
            ...
            <p className="text-slate-200 max-w-2xl mx-auto text-lg font-light leading-relaxed">
              Accessibility is the foundation. CuraVox operates reliably
              offline, ensuring absolute privacy, and utilizes high-contrast UI,
              voice-first commands, and intelligent haptics.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 relative z-10">
            <div className="flex flex-col items-center text-center gap-6 group">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-slate-200 text-lg group-hover:text-cyan-400 transition-colors">
                  Visually Impaired
                </h4>
                <p className="text-sm text-slate-300 font-light leading-relaxed">
                  Independence in identifying and managing daily medications.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center text-center gap-6 group">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-300 font-light leading-relaxed">
                  Conversational interface that doesn't require complex
                  navigation.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center text-center gap-6 group">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-300 font-light leading-relaxed">
                  Safely tracking and managing multi-drug, complex regimens.
                </p>
              </div>
            </div>
            <div className="flex flex-col items-center text-center gap-6 group">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-300 font-light leading-relaxed">
                  Synchronized track records and remote adherence monitoring.
                </p>
              </div>
            </div>
          </div>
